---
title: 'Prepare data for epigenetic data surrounding Etv2 ChIP-seq peaks at D1 post induction
...
```{r}
gs <- 'Etv2_peaks_MEF_D1_Dox_all'; extend <- 1000; w <- 50; smooth <- FALSE; target_ratio <- 0.2; mc.cores <- 2
bw_files <- c(
...
group_cols[c('MNase', 'H3', 'H3.3')] <- 'green'
group_cols['MEF_Dox_D1_Etv2'] <- 'red'
group_cols['MEF_NoDox_Brg1'] <- 'purple'
group_cols['MEF_NoDox_H3K27ac'] <- 'darkgreen'
group_cols[c('H3K9me3', 'H3K27me3', 'H3K36me3', 'H3K9ac', 'H3K79me2', 'H3K4me2', 'H3K4me1', 'Hdac1', 'P300')] <- 'blue'
...
#set.seed(1); i <- sample(length(peaks), 5000)
