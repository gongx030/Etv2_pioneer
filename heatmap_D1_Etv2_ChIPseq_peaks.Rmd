...
The script that perform the SeATAC analysis can be found here[seatac_on_D1_Etv2_ChIPseq_peaks.Rmd](seatac_on_D1_Etv2_ChIPseq_peaks.Rmd)
The script that explore the procedure of clustering v-plot can be found here [seatac_clustering_analysis_on_D1_Etv2_ChIPseq_peaks.Rmd](seatac_clustering_analysis_on_D1_Etv2_ChIPseq_peaks.Rmd)
...
col_fun[['MEF_NoDox_mono_nucleosome_vs_nfr']] <- colorRamp2(quantile(mat[['MEF_NoDox_mono_nucleosome_vs_nfr']], c(0.005, 0.5, 0.995)), c('blue', 'black', 'yellow'))
